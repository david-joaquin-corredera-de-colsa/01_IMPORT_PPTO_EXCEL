...
Public Function OLD_fun822_DetectarRangoCompletoHoja(ByRef ws As Worksheet, _
                                                ByRef vFila_Inicial As Long, _
                                                ByRef vFila_Final As Long, _
                                                ByRef vColumna_Inicial As Long, _
                                                ByRef vColumna_Final As Long) As Boolean
    ...
    '******************************************************************************
    ' FUNCIÓN AUXILIAR: fun822_DetectarRangoCompletoHoja
    ...
    ' - vFila_Inicial: Variable donde almacenar primera fila con datos
    ' - vFila_Final: Variable donde almacenar última fila con datos
    ' - vColumna_Inicial: Variable donde almacenar primera columna con datos
    ' - vColumna_Final: Variable donde almacenar última columna con datos
    '
    ' Retorna: Boolean (True si exitoso, False si error)
    ' Compatibilidad: Excel 97, 2003, 365, OneDrive, SharePoint, Teams
    '******************************************************************************
