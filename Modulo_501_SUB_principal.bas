...
'    End If
    ...
    '--------------------------------------------------------------------------
    ' 8.2. NUEVA FUNCIONALIDAD: SmartView: Crear Conexiones, Actualizar Opciones, Crear AdHoc
    '--------------------------------------------------------------------------
'    lngLineaError = 105
...
'    End If
    ...
    '--------------------------------------------------------------------------
    ' 8.3. NUEVA FUNCIONALIDAD: Copiar datos de comprobación a envío
    '--------------------------------------------------------------------------
    lngLineaError = 107
    ...
    '--------------------------------------------------------------------------
    ' 8.3. NUEVA FUNCIONALIDAD: SmartView: Enviar Datos / Submit
    '--------------------------------------------------------------------------
