...
Public Sub M001_Ejecutar_Proceso_Principal()
    ...
    '--------------------------------------------------------------------------
    ' 3a. NUEVA FUNCIONALIDAD: Localizar hoja de envío anterior
    '--------------------------------------------------------------------------
    lngLineaError = 89
    ...
    '--------------------------------------------------------------------------
    ' 3b. NUEVA FUNCIONALIDAD: Copiar hoja de envío anterior
    '--------------------------------------------------------------------------
    lngLineaError = 90
    ...
    '--------------------------------------------------------------------------
    ' 6.8. NUEVA FUNCIONALIDAD: SmartView: Crear Conexiones, Actualizar Opciones, Crear AdHoc
    '--------------------------------------------------------------------------
    
    'ThisWorkbook.Worksheets(gstrPreviaHojaImportacion_Envio).Select
    'ThisWorkbook.Worksheets(gstrPreviaHojaImportacion_Envio).Activate
    ...
    '--------------------------------------------------------------------------
    ' 7. NUEVA FUNCIONALIDAD: SmartView: Crear Conexiones, Actualizar Opciones, Crear AdHoc
    '--------------------------------------------------------------------------
    ...
    '--------------------------------------------------------------------------
    ' 8.1. NUEVA FUNCIONALIDAD: Copiar datos de comprobación a envío
    '--------------------------------------------------------------------------
    lngLineaError = 107
    ...
    '--------------------------------------------------------------------------
    ' 8.2. NUEVA FUNCIONALIDAD: SmartView: Enviar Datos / Submit
    '--------------------------------------------------------------------------
    ...
    '--------------------------------------------------------------------------
    ' 9a. NUEVA FUNCIONALIDAD: Ocultar hojas antiguas
    '--------------------------------------------------------------------------
    lngLineaError = 109
    fun801_LogMessage "Iniciando proceso de ocultación de hojas antiguas..."
    
    blnResult = F008_Ocultar_Hojas_Antiguas()
    
    If Not blnResult Then
        Err.Raise ERROR_BASE_IMPORT + 1010, strFuncion, _
            "El proceso de ocultación de hojas antiguas NO se completó correctamente"
    End If
