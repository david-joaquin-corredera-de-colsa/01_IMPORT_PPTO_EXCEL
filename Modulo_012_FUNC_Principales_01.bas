...
Public Function F000_Comprobaciones_Iniciales() As Boolean
    ...
    ' Inicialización
    strFuncion = "F000_Comprobaciones_Iniciales" 'La funcion Caller es valida solo desde Excel 2000, para Excel 97 usariamos: strFuncion = "F000_Comprobaciones_Iniciales"
    ...
    '--------------------------------------------------------------------------
    lngLineaError = 57
    ' Validar/Crear hoja Ejecutar Procesos (CONST_HOJA_EJECUTAR_PROCESOS = "00_Ejecutar_Procesos")
    If Not fun802_SheetExists(CONST_HOJA_EJECUTAR_PROCESOS) Then
        If Not F002_Crear_Hoja(CONST_HOJA_EJECUTAR_PROCESOS) Then
            Err.Raise ERROR_BASE_IMPORT + 1, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_EJECUTAR_PROCESOS
        End If
    End If
    ThisWorkbook.Worksheets(CONST_HOJA_EJECUTAR_PROCESOS).Visible = CONST_HOJA_EJECUTAR_PROCESOS_VISIBLE
    
    ' Validar/Crear hoja Inventario (const CONST_HOJA_INVENTARIO = "01_Inventario")
    If Not fun802_SheetExists(CONST_HOJA_INVENTARIO) Then
        If Not F002_Crear_Hoja(CONST_HOJA_INVENTARIO) Then
            Err.Raise ERROR_BASE_IMPORT + 2, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_INVENTARIO
        End If
    End If
    ThisWorkbook.Worksheets(CONST_HOJA_INVENTARIO).Visible = CONST_HOJA_INVENTARIO_VISIBLE
    
    
    ' Validar/Crear hoja Log (const CONST_HOJA_LOG= "02_Log")
    If Not fun802_SheetExists(CONST_HOJA_LOG) Then
        If Not F002_Crear_Hoja(CONST_HOJA_LOG) Then
            Err.Raise ERROR_BASE_IMPORT + 3, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_LOG
        End If
    End If
    ThisWorkbook.Worksheets(CONST_HOJA_LOG).Visible = CONST_HOJA_LOG_VISIBLE
    
    ' Validar/Crear hoja UserName (const CONST_HOJA_USERNAME = "05_Username")
    If Not fun802_SheetExists(CONST_HOJA_USERNAME) Then
        If Not F002_Crear_Hoja(CONST_HOJA_USERNAME) Then
            Err.Raise ERROR_BASE_IMPORT + 3, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_USERNAME
        End If
    End If
    ThisWorkbook.Worksheets(CONST_HOJA_USERNAME).Visible = CONST_HOJA_USERNAME_VISIBLE
    
    ' Validar/Crear hoja Delimitadores Originales (const CONST_HOJA_DELIMITADORES_ORIGINALES = "06_Delimitadores_Originales")
    If Not fun802_SheetExists(CONST_HOJA_DELIMITADORES_ORIGINALES) Then
        If Not F002_Crear_Hoja(CONST_HOJA_DELIMITADORES_ORIGINALES) Then
            Err.Raise ERROR_BASE_IMPORT + 3, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_DELIMITADORES_ORIGINALES
        End If
    End If
    ThisWorkbook.Worksheets(CONST_HOJA_DELIMITADORES_ORIGINALES).Visible = CONST_HOJA_DELIMITADORES_ORIGINALES_VISIBLE
    
    ' Validar/Crear hoja Delimitadores Originales (const CONST_HOJA_REPORT_PL = "09_Report_PL")
    If Not fun802_SheetExists(CONST_HOJA_REPORT_PL) Then
        If Not F002_Crear_Hoja(CONST_HOJA_REPORT_PL) Then
            Err.Raise ERROR_BASE_IMPORT + 3, strFuncion, _
                "Error al crear la hoja " & CONST_HOJA_REPORT_PL
        End If
    End If
...
Public Function F001_Crear_hojas_de_Importacion() As Boolean
    ...
    ' Inicialización
    strFuncion = "F001_Crear_hojas_de_Importacion" 'La funcion Caller es valida solo desde Excel 2000, para Excel 97 usariamos: strFuncion = "F001_Crear_hojas_de_Importacion"
    ...
    gstrNuevaHojaImportacion = CONST_PREFIJO_HOJA_IMPORTACION & strFechaHoraIsoNuevaHojaImportacion
    gstrNuevaHojaImportacion_Working = CONST_PREFIJO_HOJA_IMPORTACION_WORKING & strFechaHoraIsoNuevaHojaImportacion
    gstrNuevaHojaImportacion_Envio = CONST_PREFIJO_HOJA_IMPORTACION_ENVIO & strFechaHoraIsoNuevaHojaImportacion
    gstrNuevaHojaImportacion_Comprobacion = CONST_PREFIJO_HOJA_IMPORTACION_COMPROBACION & strFechaHoraIsoNuevaHojaImportacion
...
Public Function F002_Importar_Fichero(ByVal vNuevaHojaImportacion As String, _
    ...
    ' Inicialización
    strFuncion = "F002_Importar_Fichero" 'La funcion Caller es valida solo desde Excel 2000, para Excel 97 usariamos: strFuncion = "F002_Importar_Fichero"
